          ...
          <div className="row">
            <div className="col-lg-4 mb-4">
              <div className="jdfhgdfg">
                ...
                <p className="mb-0">
                  Join us to transform your career and build an unimaginable
                  path for you.
                </p>
              </div>
            </div>
                    ...
                    <div className="hjgfgfghghgfh">
                      ...
                      <div className="bghjdfgfdg">
                        ...
                        <div className="ghfgdfgfgffgfg">
                          ...
                          <button className="position-relative me-lg-2">
                            <i className="fa-brands position-absolute fa-linkedin-in"></i>
                          </button>
                          ...
                          <button className="position-relative me-lg-2">
                            <i className="fa-brands position-absolute fa-tiktok"></i>
                          </button>
                        </div>
                      </div>
                    </div>
